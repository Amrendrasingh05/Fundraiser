...
<br className="res-hide"></br>
<img src={how_it_works_bg} alt="" className="shape res-hide"/>
<img src={border_dashed} alt="" className="ele res-hide"/>
...
<br className="res-hide"></br>
		...
		<div className="d-flex">
			<a href="#" className="btn btn-org btn-lg m-auto" style={{"position":"relative", "zIndex":"100"}}>Get Started</a>
		</div>
...
<section className="testimonial wow fadeIn">
	<div className="container-fluid">
		...
		<img src={line} className="line2 ele" style={{"bottom":"35px", "zIndex":"1000"}} alt=""/>	  </div>	
...
<section className="home_section4 mover">
	<div className="container-fluid pl-0 w-100">
		<h2 className="hd text-center font-weight-bold pl-5 pr-5">Every order is made-to-order</h2>
		
	<br className="res-hide"></br>
	<br className="res-hide"></br>	<br className="res-hide"></br>
	<br className="res-hide"></br>
<br></br>
...
dollar supports a cause.</h2>
				<p className="font-18 mt-4 mb-0 w-75 res-full">
...
<section className="happy_family mover">
 ...
 <div className="position-relative wow fadeInUp">
	...
	<span className="rounded-circle circle2" style={{"right":"7%", "top":"12px"}}></span> </div>
...
<br></br>
		...
		<div className="owl-carousel owl-theme videos_slider" style={{"width":"75%", "margin":"auto"}}>
		
				<a className="cursor d-flex align-items-center justify-content-center" data-fancybox="" href="https://www.youtube.com/watch?v=u38Qn-cYM7M&amp;list=PLl-qccCaclBuLkirgDHVlUr5aCYA7mIYK">
			<div className="box">
				<div className="img">
					<img src={video1} className="w-100 transition" alt=""/>
					<span className="title">Mission</span>				</div>
...
<section className="newsletter pb-0 pt-0" >
		...
		<div className="box">
				...
				<span className="placeholder" style={{"color":"#31353B", "fontWeight":"500"}}>Email Address</span> 
